...
class Squarefootagecalc_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        <div id="container-damteq_calculator">
                    ...
                    <div class="field">
                        ...
                        <div class="control">
                            <input class="input" id="damteq_crossbeams" type="number"
                                   placeholder="Enter measurement" name="length" min="0" step="4.0">
                            <span>Feet</span>
                        </div>
                    </div>
                </div>
            ...
            <div class="damteq_totals crossbeams"><?php _e('4ft Cross-Beams:', 'damteq'); ?> <span></span></div>
            ...
            <div class="damteq_totals smallloftboards"><?php _e('4ft LoftBoards:', 'damteq'); ?> <span></span></div>
            ...
            $(document).ready(function () {
                ...
                function updateArea() {
                    ...
                    let a = parseFloat($('#damteq_joists').val(), 10),
                        ...
                        small = Math.ceil(a / 4 * b / 2);
                    //packs = Math.ceil(small/3);


                   // console.log(Math.round(a / 1.2) * 10);
