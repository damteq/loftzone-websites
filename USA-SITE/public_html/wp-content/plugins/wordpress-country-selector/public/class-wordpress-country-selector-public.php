...
class Wordpress_Country_Selector_Public
{
    ...
    public function init()
    {
        ...
        if( ($forceRedirect) && ($seconds == 0) ){
            ...
            $geolocate = json_decode(file_get_contents("https://extreme-ip-lookup.com/json/"));

            $this->users_country = $geolocate->countryCode;
            ...
            if(!empty($this->target_URL)) {
                if(!$is_bot && ($this->sites_URL != $this->target_URL)) {
